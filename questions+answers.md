...
3. ### <a name="3"></a>Что такое поднятие (Hoisting)?
...
4. ### <a name="4"></a>Что такое область видимости (Scope)?
...
5. ### <a name="5"></a>Отличие for...of от for...in в javascript?
