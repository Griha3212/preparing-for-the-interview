...
3. ### <a name="3"></a> 3.	Что такое поднятие (Hoisting)?
...
4. ### <a name="4"></a> 4.	Что такое область видимости (Scope)?
...
5. ### <a name="5"></a> 5.	Отличие for...of от for...in в javascript?
